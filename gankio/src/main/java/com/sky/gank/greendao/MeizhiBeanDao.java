...
/** 
 * DAO for table "MEIZHI_BEAN".
*/
public class MeizhiBeanDao extends AbstractDao<MeizhiBean, String> {

    public static final String TABLENAME = "MEIZHI_BEAN";

    /**
     * Properties of entity MeizhiBean.<br/>
    ...
    public MeizhiBeanDao(DaoConfig config) {
        super(config);
    }
    
    public MeizhiBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MEIZHI_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MEIZHI_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MeizhiBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MeizhiBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public MeizhiBean readEntity(Cursor cursor, int offset) {
        MeizhiBean entity = new MeizhiBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, MeizhiBean entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(MeizhiBean entity, long rowId) {
        return entity.get_id();
    }
    
    @Override
    public String getKey(MeizhiBean entity) {
        if(entity != null) {
            return entity.get_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(MeizhiBean entity) {
