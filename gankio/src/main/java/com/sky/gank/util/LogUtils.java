...
public class LogUtils {
    ...
    public static void v(String msg) {
        if (mDebuggable >= LEVEL_VERBOSE && !TextUtils.isEmpty(msg)) {
            Log.v(mTag, msg);
        }
    }
    /**
    ...
    public static void d(String msg ) {
        if (mDebuggable >= LEVEL_DEBUG && !TextUtils.isEmpty(msg)) {
            Log.d(mTag, msg);
        }
    }
    ...
    private static void i(String msg) {
        if (mDebuggable >= LEVEL_INFO && !TextUtils.isEmpty(msg)) {
            Log.i(mTag, msg);
        }
    }
    /**
     * 以级别为i的TAG形式输出LOG信息和THrowable
     */
    ...
    public static void w(String msg) {
        if (mDebuggable >= LEVEL_WARN && !TextUtils.isEmpty(msg)) {
            Log.w(mTag, msg);
        }
    }
    ...
    public static void w(Throwable tr) {
        if (mDebuggable >= LEVEL_WARN && null != tr) {
            Log.w(mTag, "", tr);
        }
    }
    ...
    /**
     * 以级别为 w 的形式输出LOG信息和Throwable//tag
     */
    ...
    public static void e(Throwable tr) {
        if (mDebuggable >= LEVEL_ERROR && null != tr) {
            Log.e(mTag, "", tr);
        }
    }

    /**
     * 以级别为 e的形式输出LOG信息和Throwable
     */
    ...
    /**
     * 以级别为 e的形式输出LOG信息和Throwable//mtag
     */
